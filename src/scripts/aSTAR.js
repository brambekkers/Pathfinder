    ...
    visitCell(cell) {
        return new Promise(async (resolve, reject) => {
            ...
            for (const neighbor of neighbors) {
                // Calculate the F-cost of the neighbor cells
                const cost = this.calcDistTo(neighbor.pos, this.finishCell.pos) + neighbor.aStar.weight;

                // If the new f-cost is lower than the previous f-cost
                if (cost < neighbor.aStar.fCost) {
                    neighbor.aStar.fCost = cost;
